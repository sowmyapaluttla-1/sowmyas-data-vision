...
function Portfolio() {
  ...
  return <main id="home" className="overflow-hidden">
    ...
    <section className="editorial-wrap relative py-7 pb-16 md:py-10 md:pb-24">
      ...
      <h1 className="display-title relative z-0 mt-7 text-[26vw] sm:text-[22vw] lg:text-[17rem]">DATA<br className="sm:hidden"/> ANALYST</h1>
